...
__init int mt_board_init(void)
{
	...
	{
		uint64_t key;
#if defined(CONFIG_MTK_USB_UNIQUE_SERIAL) || defined(CONFIG_MTK_SEC_FASTBOOT_UNLOCK_SUPPORT)
...
#if defined(CONFIG_CUSTOM_KERNEL_ALSPS)||defined(CONFIG_CUSTOM_KERNEL_ALS)||defined(CONFIG_CUSTOM_KERNEL_PS)
